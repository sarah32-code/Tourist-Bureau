...
window.onload = function () {
    populateCategories();
    document.getElementById("activityPurchaseForm").addEventListener("submit", handlePurchase);
};
...
function populateActivityDetails(category) {
    let activityDetailsDiv = document.getElementById("activityDetails");
    activityDetailsDiv.innerHTML = "";

    let filteredActivities = activities.filter(activity => activity.category === category);
    filteredActivities.forEach(activity => {
        ...
        activityDetailsDiv.appendChild(activityDiv);
    });
}

document.getElementById("categorySelect").addEventListener("change", function () {
    let selectedCategory = this.value;
    populateActivityDetails(selectedCategory);
});
...
function handlePurchase(event) {
    ...
    alert("Purchase completed! Details:\n" +
        "Number of Tickets: " + numTickets + "\n" +
        "Credit Card Number: " + creditCard + "\n" +
        "Email Address: " + email);
    document.getElementById("activityPurchaseForm").reset();
}